-- Fact Edit History Table
-- Supports Fact Component
-- Maintains audit trail of all fact modifications
...
-- fact_id: Foreign key linking to the fact that was edited
...
-- Note: This table preserves all edit history for transparency and moderation
